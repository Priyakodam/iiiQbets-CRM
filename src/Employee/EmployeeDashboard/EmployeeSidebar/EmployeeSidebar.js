      ...
      <div className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
        <div className="position-sticky">
          ...
          <h2 className="text-center">{user.fullName}</h2>
            ...
            <li className={`nav-item ${location.pathname === '/managemanager' ? 'active' : ''}`}>
              <Link className="nav-link" to="/managemanager" onClick={handleNavItemClick}>
                <FaTachometerAlt className="nav-icon" />
                {!collapsed && <span className="link_text">Manage Manager</span>}
              </Link>
            </li>
            ...
            <li className={`nav-item ${location.pathname === '/screening'|| location.pathname === '/a-L1candidates'|| location.pathname === '/a-L2candidates'|| location.pathname === '/a-F2Fcandidates'? 'active' : ''}`}>
